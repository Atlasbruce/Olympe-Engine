// [DEPRECATED - Phase 5 - 2026-03-07]
// Ce fichier est archivé. Il ne doit plus être inclus ni compilé.
// Remplacé par : NodeGraph::FromJson + positions JSON sauvegardées (BTGraphDocumentConverter)
// Voir : Docs/BLUEPRINT-REFACTOR-MARCH-2026.md
