// DEPRECATED: Moved to _deprecated. Use the new TaskGraphLoader (Source/TaskSystem/TaskGraphLoader.h) instead.
/**
 * @file TaskGraphLoader_v3_legacy.cpp
 * @brief [DEPRECATED] Legacy implementation for schema v2/v3 task graph JSON parsing.
 * @deprecated Use Source/TaskSystem/TaskGraphLoader.cpp for schema v4 parsing.
