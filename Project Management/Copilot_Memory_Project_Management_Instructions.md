...
**Destination :** ./Project Management/CONTEXT_ARCHIVE.md section [XXX]
...
```
**Actions à effectuer :**
1. Identifier les informations obsolètes dans ./Project Management/CONTEXT_CURRENT.md
2. Déplacer vers ./Project Management/CONTEXT_ARCHIVE.md avec justification
3. Mettre à jour ./Project Management/CONTEXT_CURRENT.md avec seulement l'essentiel
4. Logger l'opération dans ./Project Management/CONTEXT_MEMORY_LOG.md
...
2. Sauvegarder dans ./Project Management/CONTEXT_CURRENT.md (section "Urgence")
...
```
**Actions :**
1. Chercher dans ./Project Management/CONTEXT_ARCHIVE.md
2. Extraire les informations pertinentes
3. Réintégrer dans ./Project Management/CONTEXT_CURRENT.md si nécessaire
...
1. Mettre à jour `./Project Management/CONTEXT_CURRENT.md` quand :
...
1. **Minimalisme** : ./Project Management/CONTEXT_CURRENT.md doit être lisible en <2 minutes
...
- ⚠️ ./Project Management/CONTEXT_CURRENT.md contient >50 points
...
- `./Project Management/CONTEXT_CURRENT.md` : mémoire active
- `./Project Management/CONTEXT_ARCHIVE.md` : mémoire archivée
- `./Project Management/CONTEXT_STATUS.md` : état projet
- `./Project Management/CONTEXT_MEMORY_LOG.md` : journal opérations
...
Copilot : "✅ Je mets à jour ./Project Management/CONTEXT_CURRENT.md..."
...
```
11. Lire ./Project Management/CONTEXT_CURRENT.md
2. Lire ./Project Management/CONTEXT_STATUS.md
3. Vérifier date dernière purge dans ./Project Management/CONTEXT_MEMORY_LOG.md
```
...
|----------|--------------|--------|
| Points actifs dans ./Project Management/CONTEXT_CURRENT.md | >50 | Purge recommandée |
...
```
[NOUVEAU] → ./Project Management/CONTEXT_CURRENT.md (Pertinence: HAUTE)
    ↓
...
[VIEILLI] (>7j) → Évaluation pour archivage
    ↓
[OBSOLÈTE] → ./Project Management/CONTEXT_ARCHIVE.md
    ↓
...
5. Charger ./Project Management/CONTEXT_EMERGENCY.md
```
